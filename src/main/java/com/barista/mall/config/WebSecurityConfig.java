...
import com.barista.mall.security.AdminUserDetailsService;
import com.barista.mall.security.LoginAuthenticationFailHandler;
import com.barista.mall.security.LoginAuthenticationSuccessHandler;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http
                .csrf().disable()
                .authorizeRequests()
                .antMatchers("/js/**", "/images/**","/actuator/**", "/css/**", "/font/**", "/favicon.ico").permitAll()
